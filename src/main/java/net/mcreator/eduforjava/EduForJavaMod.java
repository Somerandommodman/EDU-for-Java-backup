 ...
 *
 */
package net.mcreator.eduforjava;
...
@Mod("edu_for_java")
public class EduForJavaMod {
	public static final Logger LOGGER = LogManager.getLogger(EduForJavaMod.class);
	public static final String MODID = "edu_for_java";
